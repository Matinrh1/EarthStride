...
import canvass from "../assets/back-grounds/canvas.png";
import spring from "../assets/back-grounds/spring.png";
import products from "../products/Menshoes";
import MensShoesExplore from "./MensShoesExplore";
import FAQSection from "./FAQsection";
import ProductColorsSlider from "./ProductColorsSlider";
...
const MenShoes = () => {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`men-shoes lg:flex [&@media(min-width:300px)]:p-4  pt-30 lg:pt-25 `}
      >
        {!isSidebarOpen && (
          <div
        ...
        >
          ...
          <div className="pb-5">
            <h3 className="font-semibold text-3xl">Men's Shoes</h3>
                ...
                <div className="grid grid-cols-4 gap-2">
                  {wmSizes.map((size) => (
                    <button
                      key={size}
                      onClick={() => toggleFilter("size", size)}
                      className={`border px-2 min-w-fit lg:px-3 min-h-[60px] xl:px-5 py-1 text-sm font-none hover:bg-gray-400 cursor-pointer text-center ${
                        filters.size.includes(size)
        ...
        <div className="lg:w-3/4 sm:p-4 ">
          ...
          <div className="flex py-2 justify-between lg:justify-end">
            <div className="border-1 ml-2 sm:mx-5 lg:mx-0 border-gray-500 p-[2px] rounded-full overflow-hidden flex">
              <Link to="/women" className="px-1 sm:px-3 py-2  rounded-full">
                Women
              </Link>
              <Link
                to="/men"
                className="px-3 sm:px-5 py-2 bg-slate-900 rounded-full text-white"
              >
                Men
              </Link>
            </div>
